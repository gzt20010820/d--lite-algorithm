...
typedef unordered_map<state,cellInfo, state_hash, equal_to<state> > ds_ch;//hash_map改为unordered_map
typedef unordered_map<state, float, state_hash, equal_to<state> > ds_oh;//hash_map改为unordered_map
